...
def find_almost_similar_image_locations(im_search_path, im_source_path, threshold=0.8, rgb=False):
...
class ImageMatching(object):
    ...
    def find_best_result(self):
        ...
        return best_match if confidence >= self.threshold else None, w_h_range
